...
how_hard_was_this_assignment = 'Hard, assembly is not my strong suit and I feel a lot more comfortable writing programs in Python or C++.'

# Other than just giving the answers, what could we do to make this assignment
# run more smoothly in the future?
suggestions = 'I don\'t understand why we had to find the address after the call to vulnerable() and feel like there was a lot of extra information that I was told to find that I didn\'t use.'
